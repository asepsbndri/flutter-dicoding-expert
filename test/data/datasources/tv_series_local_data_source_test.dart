...
void main() {
  ...
  group('save watchlist', () {
    ...
    test('should throw DatabaseException when insert to database is failed',
      ...
      // act & assert
      expect(
        () async => await dataSource.insertWatchlist(testTvSeriesTable),
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success',
        () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlist(testTvSeriesTable.id, 'tv'))
          .thenAnswer((_) async => 1);
      // act
    ...
    test('should throw DatabaseException when remove from database is failed',
      ...
      // act & assert
      expect(
        () async => await dataSource.removeWatchlist(testTvSeriesTable),
        throwsA(isA<DatabaseException>()),
      );
    });
  });
  ...
  group('Get TvSeries Detail By Id', () {
    ...
    test('should return null when data is not found', () async {
      // arrange
      when(mockDatabaseHelper.getItemById(tId, 'tv'))
  ...
  group('get watchlist tv series', () {
    test('should return list of TvSeriesTable from database', () async {
      // arrange
      when(mockDatabaseHelper.getWatchlistByType('tv'))
